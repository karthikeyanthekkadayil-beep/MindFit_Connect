...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-primary/10 via-background to-secondary/10 safe-area-inset">
      {/* Header */}
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      required
                      className="h-12 rounded-xl bg-muted/30 border-0 focus:bg-background focus:ring-2 focus:ring-primary/20"
                    />
                  </div>
                  <div className="space-y-2">
